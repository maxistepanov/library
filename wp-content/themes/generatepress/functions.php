...
{
	?>
	<span class="copyright"><?php _e('Бібліотека «ХНЕУ»','generatepress');?> &copy; <?php echo date('Y'); ?></span>
	<?php
}
endif;
...
{
	?>
	&#x000B7; <a href="<?php echo esc_url('http://library.hneu.edu.ua/');?>" target="_blank" title="Бібліотека «ХНЕУ»" itemprop="url">GeneratePress</a>
	<?php
}
endif;
